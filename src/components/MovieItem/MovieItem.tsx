...
import { getRate } from '../../api/apiServices';
...
const MovieItem: React.FC<MovieItemProps> = ({ movie, onRate }) => {
  ...
  const localRate = Number(getRate(id.toString()));
  const [rate, setRate] = useState<number>(localRate || 0);
        ...
        return (
          <li className="movie-card">
            ...
            <div className="movie-card__content">
              ...
              <Rate className="movie-card__rate" count={10} allowHalf defaultValue={rate} onChange={onChangeRate} />
            </div>
          </li>
        );
      }}
